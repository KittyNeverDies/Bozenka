...
class Command(BaseCommand):
    help = 'Launch all instances of bozenka bots in parallel'
    ...
    def handle(self, *args, **kwargs):
        ...
        try:
            asyncio.run(self.launch_instances())
        except KeyboardInterrupt:
            logging.info("Program interrupted by user, software or something other.\n"
                         "We are shutting down.")


    async def launch_instances(self) -> None:
        """
        Launch all instances of bozenka bots in parallel
